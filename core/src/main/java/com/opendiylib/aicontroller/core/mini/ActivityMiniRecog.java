package com.opendiylib.aicontroller.core.mini;
...
import com.opendiylib.aicontroller.core.R;
import com.opendiylib.aicontroller.core.inputstream.InFileStream;
...
public class ActivityMiniRecog extends AppCompatActivity implements EventListener {
    ...
    private void start() {
        ...
        // params.put(SpeechConstant.IN_FILE, "#com.opendiylib.aicontroller.core.inputstream.InFileStream.createMyPipedInputStream()");
